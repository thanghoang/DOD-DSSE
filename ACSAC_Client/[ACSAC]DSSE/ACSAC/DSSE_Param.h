...
#define MAX_NUM_KEYWORDS 150000																					   // Defines the maximum number of keywords for the scheme
#define MAX_NUM_OF_FILES 150000		
#define MATRIX_PIECE_COL_SIZE (MATRIX_COL_SIZE/50)
static const string gcsDataStructureFilepath = "/scratch/DSSE/ds/ACSAC/150000F_data_structure_file/";

static const string gcsFilepath = "/scratch/DSSE/db/ACSAC/150000F/";			// Absolute path of files directory


static const string gcsMatrixPiece = gcsDataStructureFilepath + "/matrix/";
															   ...
															   // Defines the maximum number of files for the scheme
...
//#define PEER_ADDRESS_0 "tcp://128.193.38.87:4433" //babylon 03
//#define PEER_ADDRESS_1 "tcp://128.193.38.19:4433" //babylon 02



//#define PEER_ADDRESS_0 "tcp://52.23.228.118:4433" //EC2 Virginia
//#define PEER_ADDRESS_0 "tcp://52.40.74.73:4433" //EC2 Oregon
#define PEER_ADDRESS_0 "tcp://52.9.223.137:4433" //EC2 North Cali
#define PEER_ADDRESS_1 "tcp://52.9.223.65:4433"
//#define PEER_ADDRESS_1 "tcp://52.10.136.48:4433" //EC2 Oregon 2
//#define PEER_ADDRESS_1 "tcp://54.67.109.40:4433" //EC2 California



//#define PEER_ADDRESS_0 "tcp://52.26.25.248:4433" //Amazon EC2
//#define PEER_ADDRESS_1 "tcp://13.84.225.180:4433" //Microsoft Azure
...
#define LARGE_SOCKET_BUFFER_SIZE (MATRIX_ROW_SIZE/BYTE_SIZE*NUM_IDX_PER_DIM + NUM_IDX_PER_DIM * MATRIX_COL_SIZE) 
//MACROS
...
static const string gcsEncFilepath = "/home/thanghoang/Desktop/encr_file/";				// Absolute path of encrypted files directory
static const string gcsUpdateFilepath = "/home/thanghoang/Desktop/up_file/";			// Absolute path of files directory
static const string gcsEncryptedUpdateFilepath = "/home/thanghoang/Desktop/encr_up_file/";
