...
WorkspacePath          := "/scratch/simulation_thanghoang/ACSAC_Server/[ACSAC]DSSE"
ProjectPath            := "/scratch/simulation_thanghoang/ACSAC_Server/[ACSAC]DSSE/ACSAC"
...
User                   :=Daniel Lin
Date                   :=22/03/16
CodeLitePath           :="/home/daniellin/.codelite"
LinkerName             :=/bin/g++
SharedObjectLinkerName :=/bin/g++ -shared -fPIC
ObjectSuffix           :=.o
DependSuffix           :=.o.d
PreprocessSuffix       :=.i
DebugSwitch            :=-g 
...
IncludePath            :=   $(IncludeSwitch)/scratch/simulation_thanghoang/ACSAC_Server/[ACSAC]DSSE/ACSAC/ $(IncludeSwitch)/scratch/simulation_thanghoang/include/
IncludePCH             := 
RcIncludePath          := 
Libs                   := 
ArLibs                 :=  
LibPath                := $(LibraryPathSwitch)/scratch/simulation_thanghoang/lib 
...
$(IntermediateDirectory)/Client_DSSE.cpp$(ObjectSuffix): Client_DSSE.cpp $(IntermediateDirectory)/Client_DSSE.cpp$(DependSuffix)
	$(CXX) $(IncludePCH) $(SourceSwitch) "/scratch/simulation_thanghoang/ACSAC_Server/[ACSAC]DSSE/ACSAC/Client_DSSE.cpp" $(CXXFLAGS) $(ObjectSwitch)$(IntermediateDirectory)/Client_DSSE.cpp$(ObjectSuffix) $(IncludePath)
...
$(IntermediateDirectory)/Krawczyk128_KDF.cpp$(ObjectSuffix): Krawczyk128_KDF.cpp $(IntermediateDirectory)/Krawczyk128_KDF.cpp$(DependSuffix)
	$(CXX) $(IncludePCH) $(SourceSwitch) "/scratch/simulation_thanghoang/ACSAC_Server/[ACSAC]DSSE/ACSAC/Krawczyk128_KDF.cpp" $(CXXFLAGS) $(ObjectSwitch)$(IntermediateDirectory)/Krawczyk128_KDF.cpp$(ObjectSuffix) $(IncludePath)
...
$(IntermediateDirectory)/jg_timing.c$(ObjectSuffix): jg_timing.c $(IntermediateDirectory)/jg_timing.c$(DependSuffix)
	$(CC) $(SourceSwitch) "/scratch/simulation_thanghoang/ACSAC_Server/[ACSAC]DSSE/ACSAC/jg_timing.c" $(CFLAGS) $(ObjectSwitch)$(IntermediateDirectory)/jg_timing.c$(ObjectSuffix) $(IncludePath)
...
$(IntermediateDirectory)/Miscellaneous.cpp$(ObjectSuffix): Miscellaneous.cpp $(IntermediateDirectory)/Miscellaneous.cpp$(DependSuffix)
	$(CXX) $(IncludePCH) $(SourceSwitch) "/scratch/simulation_thanghoang/ACSAC_Server/[ACSAC]DSSE/ACSAC/Miscellaneous.cpp" $(CXXFLAGS) $(ObjectSwitch)$(IntermediateDirectory)/Miscellaneous.cpp$(ObjectSuffix) $(IncludePath)
...
$(IntermediateDirectory)/DSSE.cpp$(ObjectSuffix): DSSE.cpp $(IntermediateDirectory)/DSSE.cpp$(DependSuffix)
	$(CXX) $(IncludePCH) $(SourceSwitch) "/scratch/simulation_thanghoang/ACSAC_Server/[ACSAC]DSSE/ACSAC/DSSE.cpp" $(CXXFLAGS) $(ObjectSwitch)$(IntermediateDirectory)/DSSE.cpp$(ObjectSuffix) $(IncludePath)
...
$(IntermediateDirectory)/DSSE_Hashmap_Key_Class.cpp$(ObjectSuffix): DSSE_Hashmap_Key_Class.cpp $(IntermediateDirectory)/DSSE_Hashmap_Key_Class.cpp$(DependSuffix)
	$(CXX) $(IncludePCH) $(SourceSwitch) "/scratch/simulation_thanghoang/ACSAC_Server/[ACSAC]DSSE/ACSAC/DSSE_Hashmap_Key_Class.cpp" $(CXXFLAGS) $(ObjectSwitch)$(IntermediateDirectory)/DSSE_Hashmap_Key_Class.cpp$(ObjectSuffix) $(IncludePath)
...
$(IntermediateDirectory)/Keyword_Extraction.cpp$(ObjectSuffix): Keyword_Extraction.cpp $(IntermediateDirectory)/Keyword_Extraction.cpp$(DependSuffix)
	$(CXX) $(IncludePCH) $(SourceSwitch) "/scratch/simulation_thanghoang/ACSAC_Server/[ACSAC]DSSE/ACSAC/Keyword_Extraction.cpp" $(CXXFLAGS) $(ObjectSwitch)$(IntermediateDirectory)/Keyword_Extraction.cpp$(ObjectSuffix) $(IncludePath)
...
$(IntermediateDirectory)/DSSE_Trapdoor.cpp$(ObjectSuffix): DSSE_Trapdoor.cpp $(IntermediateDirectory)/DSSE_Trapdoor.cpp$(DependSuffix)
	$(CXX) $(IncludePCH) $(SourceSwitch) "/scratch/simulation_thanghoang/ACSAC_Server/[ACSAC]DSSE/ACSAC/DSSE_Trapdoor.cpp" $(CXXFLAGS) $(ObjectSwitch)$(IntermediateDirectory)/DSSE_Trapdoor.cpp$(ObjectSuffix) $(IncludePath)
...
$(IntermediateDirectory)/DSSE_FileCrypt.cpp$(ObjectSuffix): DSSE_FileCrypt.cpp $(IntermediateDirectory)/DSSE_FileCrypt.cpp$(DependSuffix)
	$(CXX) $(IncludePCH) $(SourceSwitch) "/scratch/simulation_thanghoang/ACSAC_Server/[ACSAC]DSSE/ACSAC/DSSE_FileCrypt.cpp" $(CXXFLAGS) $(ObjectSwitch)$(IntermediateDirectory)/DSSE_FileCrypt.cpp$(ObjectSuffix) $(IncludePath)
...
$(IntermediateDirectory)/MasterKey.cpp$(ObjectSuffix): MasterKey.cpp $(IntermediateDirectory)/MasterKey.cpp$(DependSuffix)
	$(CXX) $(IncludePCH) $(SourceSwitch) "/scratch/simulation_thanghoang/ACSAC_Server/[ACSAC]DSSE/ACSAC/MasterKey.cpp" $(CXXFLAGS) $(ObjectSwitch)$(IntermediateDirectory)/MasterKey.cpp$(ObjectSuffix) $(IncludePath)
...
$(IntermediateDirectory)/DSSE_KeyGen.cpp$(ObjectSuffix): DSSE_KeyGen.cpp $(IntermediateDirectory)/DSSE_KeyGen.cpp$(DependSuffix)
	$(CXX) $(IncludePCH) $(SourceSwitch) "/scratch/simulation_thanghoang/ACSAC_Server/[ACSAC]DSSE/ACSAC/DSSE_KeyGen.cpp" $(CXXFLAGS) $(ObjectSwitch)$(IntermediateDirectory)/DSSE_KeyGen.cpp$(ObjectSuffix) $(IncludePath)
...
$(IntermediateDirectory)/Server_DSSE.cpp$(ObjectSuffix): Server_DSSE.cpp $(IntermediateDirectory)/Server_DSSE.cpp$(DependSuffix)
	$(CXX) $(IncludePCH) $(SourceSwitch) "/scratch/simulation_thanghoang/ACSAC_Server/[ACSAC]DSSE/ACSAC/Server_DSSE.cpp" $(CXXFLAGS) $(ObjectSwitch)$(IntermediateDirectory)/Server_DSSE.cpp$(ObjectSuffix) $(IncludePath)
...
$(IntermediateDirectory)/net.c$(ObjectSuffix): net.c $(IntermediateDirectory)/net.c$(DependSuffix)
	$(CC) $(SourceSwitch) "/scratch/simulation_thanghoang/ACSAC_Server/[ACSAC]DSSE/ACSAC/net.c" $(CFLAGS) $(ObjectSwitch)$(IntermediateDirectory)/net.c$(ObjectSuffix) $(IncludePath)
...
$(IntermediateDirectory)/main_server.cpp$(ObjectSuffix): main_server.cpp $(IntermediateDirectory)/main_server.cpp$(DependSuffix)
	$(CXX) $(IncludePCH) $(SourceSwitch) "/scratch/simulation_thanghoang/ACSAC_Server/[ACSAC]DSSE/ACSAC/main_server.cpp" $(CXXFLAGS) $(ObjectSwitch)$(IntermediateDirectory)/main_server.cpp$(ObjectSuffix) $(IncludePath)
...
$(IntermediateDirectory)/CTokenInfo.cpp$(ObjectSuffix): CTokenInfo.cpp $(IntermediateDirectory)/CTokenInfo.cpp$(DependSuffix)
	$(CXX) $(IncludePCH) $(SourceSwitch) "/scratch/simulation_thanghoang/ACSAC_Server/[ACSAC]DSSE/ACSAC/CTokenInfo.cpp" $(CXXFLAGS) $(ObjectSwitch)$(IntermediateDirectory)/CTokenInfo.cpp$(ObjectSuffix) $(IncludePath)
...
$(IntermediateDirectory)/threadPrecomputedKey.cpp$(ObjectSuffix): threadPrecomputedKey.cpp $(IntermediateDirectory)/threadPrecomputedKey.cpp$(DependSuffix)
	$(CXX) $(IncludePCH) $(SourceSwitch) "/scratch/simulation_thanghoang/ACSAC_Server/[ACSAC]DSSE/ACSAC/threadPrecomputedKey.cpp" $(CXXFLAGS) $(ObjectSwitch)$(IntermediateDirectory)/threadPrecomputedKey.cpp$(ObjectSuffix) $(IncludePath)
...
$(IntermediateDirectory)/threadDataTransmit.cpp$(ObjectSuffix): threadDataTransmit.cpp $(IntermediateDirectory)/threadDataTransmit.cpp$(DependSuffix)
	$(CXX) $(IncludePCH) $(SourceSwitch) "/scratch/simulation_thanghoang/ACSAC_Server/[ACSAC]DSSE/ACSAC/threadDataTransmit.cpp" $(CXXFLAGS) $(ObjectSwitch)$(IntermediateDirectory)/threadDataTransmit.cpp$(ObjectSuffix) $(IncludePath)
...
$(IntermediateDirectory)/struct_threadGetKeyInfo.cpp$(ObjectSuffix): struct_threadGetKeyInfo.cpp $(IntermediateDirectory)/struct_threadGetKeyInfo.cpp$(DependSuffix)
	$(CXX) $(IncludePCH) $(SourceSwitch) "/scratch/simulation_thanghoang/ACSAC_Server/[ACSAC]DSSE/ACSAC/struct_threadGetKeyInfo.cpp" $(CXXFLAGS) $(ObjectSwitch)$(IntermediateDirectory)/struct_threadGetKeyInfo.cpp$(ObjectSuffix) $(IncludePath)
$(IntermediateDirectory)/struct_threadGetKeyInfo.cpp$(DependSuffix): struct_threadGetKeyInfo.cpp
	@$(CXX) $(CXXFLAGS) $(IncludePCH) $(IncludePath) -MG -MP -MT$(IntermediateDirectory)/struct_threadGetKeyInfo.cpp$(ObjectSuffix) -MF$(IntermediateDirectory)/struct_threadGetKeyInfo.cpp$(DependSuffix) -MM "struct_threadGetKeyInfo.cpp"

$(IntermediateDirectory)/struct_threadGetKeyInfo.cpp$(PreprocessSuffix): struct_threadGetKeyInfo.cpp
	$(CXX) $(CXXFLAGS) $(IncludePCH) $(IncludePath) $(PreprocessOnlySwitch) $(OutputSwitch) $(IntermediateDirectory)/struct_threadGetKeyInfo.cpp$(PreprocessSuffix) "struct_threadGetKeyInfo.cpp"

$(IntermediateDirectory)/struct_threadCreateNewDataRepresentation.cpp$(ObjectSuffix): struct_threadCreateNewDataRepresentation.cpp $(IntermediateDirectory)/struct_threadCreateNewDataRepresentation.cpp$(DependSuffix)
	$(CXX) $(IncludePCH) $(SourceSwitch) "/scratch/simulation_thanghoang/ACSAC_Server/[ACSAC]DSSE/ACSAC/struct_threadCreateNewDataRepresentation.cpp" $(CXXFLAGS) $(ObjectSwitch)$(IntermediateDirectory)/struct_threadCreateNewDataRepresentation.cpp$(ObjectSuffix) $(IncludePath)
$(IntermediateDirectory)/struct_threadCreateNewDataRepresentation.cpp$(DependSuffix): struct_threadCreateNewDataRepresentation.cpp
	@$(CXX) $(CXXFLAGS) $(IncludePCH) $(IncludePath) -MG -MP -MT$(IntermediateDirectory)/struct_threadCreateNewDataRepresentation.cpp$(ObjectSuffix) -MF$(IntermediateDirectory)/struct_threadCreateNewDataRepresentation.cpp$(DependSuffix) -MM "struct_threadCreateNewDataRepresentation.cpp"

$(IntermediateDirectory)/struct_threadCreateNewDataRepresentation.cpp$(PreprocessSuffix): struct_threadCreateNewDataRepresentation.cpp
	$(CXX) $(CXXFLAGS) $(IncludePCH) $(IncludePath) $(PreprocessOnlySwitch) $(OutputSwitch) $(IntermediateDirectory)/struct_threadCreateNewDataRepresentation.cpp$(PreprocessSuffix) "struct_threadCreateNewDataRepresentation.cpp"
